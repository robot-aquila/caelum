...
public class SymbolServiceBuilderTest {
	...
	ISymbolServiceBuilder builderMock;
	ISymbolService serviceMock;
	...
	public void setUp() throws Exception {
		...
		builderMock = control.createMock(ISymbolServiceBuilder.class);
		serviceMock = control.createMock(ISymbolService.class);
