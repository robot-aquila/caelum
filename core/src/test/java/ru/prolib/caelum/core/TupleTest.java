...
public class TupleTest {
	...
	public void testCtor9() {
		service = new Tuple(771L, 802L, 750L, 799L, (byte)5,
	...
	public void testEquals() {
		...
		assertTrue(service.equals(new Tuple(771L, 802L, 750L, 799L, (byte)5,
				240L, BigInteger.valueOf(26L), (byte)2,
				TupleType.LONG_WIDEVOL)));
		assertFalse(service.equals(new Tuple(250L, 802L, 750L, 799L, (byte)5,
				240L, BigInteger.valueOf(26L), (byte)2,
				TupleType.LONG_WIDEVOL)));
		assertFalse(service.equals(new Tuple(771L, 250L, 750L, 799L, (byte)5,
				240L, BigInteger.valueOf(26L), (byte)2,
				TupleType.LONG_WIDEVOL)));
		assertFalse(service.equals(new Tuple(771L, 802L, 250L, 799L, (byte)5,
				240L, BigInteger.valueOf(26L), (byte)2,
				TupleType.LONG_WIDEVOL)));
		assertFalse(service.equals(new Tuple(771L, 802L, 750L, 250L, (byte)5,
				240L, BigInteger.valueOf(26L), (byte)2,
				TupleType.LONG_WIDEVOL)));
		assertFalse(service.equals(new Tuple(771L, 802L, 750L, 799L, (byte)1,
				240L, BigInteger.valueOf(26L), (byte)2,
				TupleType.LONG_WIDEVOL)));
		assertFalse(service.equals(new Tuple(771L, 802L, 750L, 799L, (byte)5,
