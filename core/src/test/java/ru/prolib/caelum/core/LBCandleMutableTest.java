...
public class LBCandleMutableTest {
	LBCandleMutable service;
	
	@Before
	public void setUp() throws Exception {
		service = new LBCandleMutable();
	}
	
	@Test
	public void testCtor_Default() {
		assertEquals(CandleRecordType.LONG_UNKNOWN, service.getType());
		assertEquals(CandleRecordType.LONG_UNKNOWN, service.type);
	...
	public void testCtor9() {
		service = new LBCandleMutable(771L, 802L, 750L, 799L, (byte)5,
		...
		assertEquals(CandleRecordType.LONG_WIDEVOL, service.type);
	...
	public void testDirectAccessAndGetters() {
		service.type = CandleRecordType.LONG_WIDEVOL;
		service.open = 1890L;
		service.high = 2000L;
		service.low  = 1850L;
		service.close= 1900L;
	...
	public void testEquals() {
		...
		assertTrue(service.equals(new LBCandleMutable(771L, 802L, 750L, 799L, (byte)5,
				240L, BigInteger.valueOf(26L), (byte)2,
				CandleRecordType.LONG_WIDEVOL)));
		assertFalse(service.equals(new LBCandleMutable(250L, 802L, 750L, 799L, (byte)5,
				240L, BigInteger.valueOf(26L), (byte)2,
				CandleRecordType.LONG_WIDEVOL)));
		assertFalse(service.equals(new LBCandleMutable(771L, 250L, 750L, 799L, (byte)5,
				240L, BigInteger.valueOf(26L), (byte)2,
				CandleRecordType.LONG_WIDEVOL)));
		assertFalse(service.equals(new LBCandleMutable(771L, 802L, 250L, 799L, (byte)5,
				240L, BigInteger.valueOf(26L), (byte)2,
				CandleRecordType.LONG_WIDEVOL)));
		assertFalse(service.equals(new LBCandleMutable(771L, 802L, 750L, 250L, (byte)5,
				240L, BigInteger.valueOf(26L), (byte)2,
				CandleRecordType.LONG_WIDEVOL)));
		assertFalse(service.equals(new LBCandleMutable(771L, 802L, 750L, 799L, (byte)1,
				240L, BigInteger.valueOf(26L), (byte)2,
				CandleRecordType.LONG_WIDEVOL)));
		assertFalse(service.equals(new LBCandleMutable(771L, 802L, 750L, 799L, (byte)5,
