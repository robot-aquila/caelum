...
public class LBCandleSerializerTest {
	...
	public void testSerialize_SimpleCase_AllAbsoluteAndSmallVolume() {
		candle = new LBCandleMutable(1600245L, 48640001L, 10L, 430L, (byte)3,
				100000L, null, (byte)5, CandleRecordType.LONG_UNKNOWN);
	...
	public void testSerialize_AllRelativeAndBigVolume() {
		candle = new LBCandleMutable(17726618283001L, 17726618285555L, 17726618283021L, 17726618212071L, (byte)10,
				0L, new BigInteger("1000778800000001886620000012222"), (byte)5, CandleRecordType.LONG_UNKNOWN);
	...
	public void testSerialize_HalfRelativeAndSmallVolume() {
		candle = new LBCandle(17726618283001L, 17726618201021L, -94522L, -586L, (byte)14,
				1L, null, (byte)2, CandleRecordType.LONG_UNKNOWN);
