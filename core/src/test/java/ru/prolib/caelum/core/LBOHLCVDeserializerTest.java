...
public class LBOHLCVDeserializerTest {
	LBOHLCVDeserializer service;
	
	@Before
	public void setUp() throws Exception {
		service = new LBOHLCVDeserializer();
	}
	...
	public void testDeserialize_SimpleCase_AllAbsoluteAndSmallVolume() {
		...
		LBOHLCV expected = new LBOHLCV(1600245L, 48640001L, 10L, 430L, (byte)3,
				100000L, null, (byte)5, OHLCVRecordType.LONG_REGULAR);
	...
	public void testDeserialize_AllRelativeAndBigVolume() {
		...
		LBOHLCV expected = new LBOHLCV(17726618283001L, 17726618285555L, 17726618283021L, 17726618212071L, (byte)10,
				0L, new BigInteger("1000778800000001886620000012222"), (byte)5, OHLCVRecordType.LONG_WIDEVOL);
		assertEquals(expected, service.deserialize(null, bytes));
	}
	...
	public void testDeserialize_HalfRelativeAndSmallVolume() {
		...
		LBOHLCV expected = new LBOHLCV(17726618283001L, 17726618201021L, -94522L, -586L, (byte)14,
				1L, null, (byte)2, OHLCVRecordType.LONG_REGULAR);
		assertEquals(expected, service.deserialize(null, bytes));
	}
