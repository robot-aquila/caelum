...
public class ItemSerializerTest {
	ItemSerializer service;

	@Before
	public void setUp() throws Exception {
		service = new ItemSerializer();
	}
	...
	public void testSerialize_LongCompact_VolumeLimit() {
		...
		assertArrayEquals(expected, service.serialize(null, new Item(23956, 3, 63, 1)));
	}
	...
	public void testSerialize_LongCompact_AtValueLimit() {
		...
		assertArrayEquals(expected, service.serialize(null, new Item(Short.MAX_VALUE, 15, 25, 0)));
	}
	...
	public void testSerialize_LongRegular_NegativeValue() {
		...
		assertArrayEquals(expected, service.serialize(null, new Item(-7789123455990781L, 15, 1, 0)));
	}
	...
	public void testSerialize_LongRegular() {
		...
		assertArrayEquals(expected, service.serialize(null, new Item(819727689123L, 5, 7272688L, 15)));
	}
