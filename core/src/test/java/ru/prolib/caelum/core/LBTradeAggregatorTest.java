...
public class LBTradeAggregatorTest {
	...
	LBCandleMutable candle, expected, actual;

	@Before
	public void setUp() throws Exception {
		service = new LBTradeAggregator();
		candle = new LBCandleMutable();
	}
	...
	public void testApply_FirstTrade() {
		...
		expected = new LBCandleMutable(45000L, 45000L, 45000L, 45000L, (byte)2,
				10L, null, (byte)0, CandleRecordType.LONG_REGULAR);
	...
	public void testApply_NextTrade_NewHigh() {
		...
		expected = new LBCandleMutable(45000L, 49000L, 45000L, 49000L, (byte)2,
				11L, null, (byte)0, CandleRecordType.LONG_REGULAR);
		assertEquals(expected, actual);
		assertSame(candle, actual);
	}
	...
	public void testApply_NextTrade_NewLow() {
		...
		expected = new LBCandleMutable(45000L, 49000L, 43900L, 43900L, (byte)2,
				16L, null, (byte)0, CandleRecordType.LONG_REGULAR);
		assertEquals(expected, actual);
		assertSame(candle, actual);
	}
	...
	public void testApply_NextTrade_SwitchedToBigInt() {
		...
		expected = new LBCandleMutable(45000L, 49000L, 43900L, 46000L, (byte)2,
				0L, new BigInteger("9223372036854775823"), (byte)0, CandleRecordType.LONG_WIDEVOL);
		assertEquals(expected, actual);
		assertSame(candle, actual);
	}
