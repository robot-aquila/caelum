...
public class TupleSerializerTest {
	TupleSerializer service;
	Tuple tuple;

	@Before
	public void setUp() throws Exception {
		service = new TupleSerializer();
	}
	
	@Test
	public void testSerialize_SimpleCase_AllAbsoluteAndSmallVolume() {
		tuple = new Tuple(1600245L, 48640001L, 10L, 430L, (byte)3,
	...
	public void testSerialize_AllRelativeAndBigVolume() {
		tuple = new Tuple(17726618283001L, 17726618285555L, 17726618283021L, 17726618212071L, (byte)10,
	...
	public void testSerialize_HalfRelativeAndSmallVolume() {
		tuple = new Tuple(17726618283001L, 17726618201021L, -94522L, -586L, (byte)14,
