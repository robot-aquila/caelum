...
public class TupleDeserializerTest {
	TupleDeserializer service;
	
	@Before
	public void setUp() throws Exception {
		service = new TupleDeserializer();
	}
	...
	public void testDeserialize_SimpleCase_AllAbsoluteAndSmallVolume() {
		...
		Tuple expected = new Tuple(1600245L, 48640001L, 10L, 430L, (byte)3,
	...
	public void testDeserialize_AllRelativeAndBigVolume() {
		...
		Tuple expected = new Tuple(17726618283001L, 17726618285555L, 17726618283021L, 17726618212071L, (byte)10,
	...
	public void testDeserialize_HalfRelativeAndSmallVolume() {
		...
		Tuple expected = new Tuple(17726618283001L, 17726618201021L, -94522L, -586L, (byte)14,
