 ...
 */
public class LBCandle implements ILBCandle {
	private final CandleRecordType type;
	...
	public boolean equals(Object other) {
		...
		if ( other == null || other.getClass() != LBCandle.class ) {
			return false;
		}
		LBCandle o = (LBCandle) other;
