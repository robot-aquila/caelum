...
public class LBCandleMutable implements ILBCandle {
	CandleRecordType type = CandleRecordType.LONG_UNKNOWN;
	...
	public LBCandleMutable() {
		
	}
	
	public LBCandleMutable(long open, long high, long low, long close, byte price_decimals,
	...
	@Override
	public CandleRecordType getType() {
		return type;
	}
	...
	public boolean equals(Object other) {
		...
		if ( other == null || other.getClass() != LBCandleMutable.class ) {
			return false;
		}
		LBCandleMutable o = (LBCandleMutable) other;
