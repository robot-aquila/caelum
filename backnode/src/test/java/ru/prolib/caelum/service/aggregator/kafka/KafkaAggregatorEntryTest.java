...
public class KafkaAggregatorEntryTest {
	...
	ru.prolib.caelum.lib.HostInfo hostInfo1, hostInfo2;
	...
	public void setUp() throws Exception {
		...
		hostInfo1 = new ru.prolib.caelum.lib.HostInfo("foobar", 10023);
		hostInfo2 = new ru.prolib.caelum.lib.HostInfo("lowpan", 44321);
