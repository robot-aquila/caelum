...
public class SymbolServiceConfigTest {
	...
	void verifyDefaultProperties(Properties props) {
		assertEquals("ru.prolib.caelum.service.symboldb.fdb.FDBSymbolServiceBuilder",
				props.get("caelum.symboldb.builder"));
		assertEquals("ru.prolib.caelum.service.symboldb.CommonCategoryExtractor",
				props.get("caelum.symboldb.category.extractor"));
