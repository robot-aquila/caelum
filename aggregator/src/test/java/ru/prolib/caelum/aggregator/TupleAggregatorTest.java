...
public class TupleAggregatorTest {
	...
	TupleAggregator service;
	Tuple aggregate, expected, actual;
	
	@Before
	public void setUp() throws Exception {
		service = new TupleAggregator();
		aggregate = new Tuple();
	}
	
	@Test
	public void testApply_FirstValue_Regular() {
		actual = service.apply("bar", new Tuple(1200L, 1250L, 1190L, 1205L, (byte)2,
				100L, null, (byte)0, LONG_REGULAR), aggregate);
		
		expected = new Tuple(1200L, 1250L, 1190L, 1205L, (byte)2,
	...
	public void testApply_FirstValue_WideVol() {
		actual = service.apply("bar", new Tuple(1250L, 1300L, 1190L, 1200L, (byte)1,
				0L, new BigInteger("25000000"), (byte)10, LONG_WIDEVOL), aggregate);
		
		expected = new Tuple(1250L, 1300L, 1190L, 1200L, (byte)1,
	...
	public void testApply_NextValue_ThrowsIfValueDecimalsMismatch() {
		service.apply("bar", new Tuple(1250L, 1300L, 1190L, 1200L, (byte)1,
				0L, new BigInteger("25000000"), (byte)10, LONG_WIDEVOL), aggregate);
		eex.expect(IllegalArgumentException.class);
		eex.expectMessage("Value decimals mismatch: symbol: bar, expected: 1, actual: 3");
		
		service.apply("bar", new Tuple(1400L, 1405L, 1000L, 1100L, (byte)3,
	...
	public void testApply_NextValue_ThrowsIfVolumeDecimalsMismatch() {
		...
		service.apply("bar", new Tuple(1400L, 1405L, 1000L, 1100L, (byte)1,
				1L, null, (byte)7, LONG_REGULAR), aggregate);
	}
	
	@Test
	public void testApply_NextValue_NewHigh() {
		service.apply("bar", new Tuple(1200L, 1250L, 1190L, 1205L, (byte)2,
				100L, null, (byte)0, LONG_REGULAR), aggregate);
		
		actual = service.apply("bar", new Tuple(1210L, 1350L, 1200L, 1230L, (byte)2,
				500L, null, (byte)0, LONG_REGULAR), aggregate);
		
		expected = new Tuple(1200L, 1350L, 1190L, 1230L, (byte)2,
	...
	public void testApply_NextValue_NewLow() {
		...
		actual = service.apply("bar", new Tuple(1210L, 1210L, 1150L, 1240L, (byte)2,
				700L, null, (byte)0, LONG_REGULAR), aggregate);
		
		expected = new Tuple(1200L, 1250L, 1150L, 1240L, (byte)2,
	...
	public void testApply_NextValue_SwitchedToBigInt_TwoLongs() {
		...
		actual = service.apply("bar", new Tuple(1210L, 1210L, 1200L, 1200L, (byte)2,
				Long.MAX_VALUE, null, (byte)0, LONG_REGULAR), aggregate);
		
		expected = new Tuple(1200L, 1250L, 1190L, 1200L, (byte)2,
