...
import ru.prolib.caelum.aggregator.kafka.KafkaTupleSerializer;
import ru.prolib.caelum.core.TupleType;

public class KafkaTupleSerializerTest {
	KafkaTupleSerializer service;
	KafkaTuple tuple;

	@Before
	public void setUp() throws Exception {
		service = new KafkaTupleSerializer();
	}
	
	@Test
	public void testHashCode() {
		int expected = 4026901;
	...
	public void testEquals() {
		...
		assertTrue(service.equals(new KafkaTupleSerializer()));
	...
	public void testSerialize_SimpleCase_AllAbsoluteAndSmallVolume() {
		tuple = new KafkaTuple(1600245L, 48640001L, 10L, 430L, (byte)3,
				100000L, null, (byte)5, TupleType.LONG_UNKNOWN);
		...
		byte actual[] = service.serialize(null, tuple);
	...
	public void testSerialize_AllRelativeAndBigVolume() {
		tuple = new KafkaTuple(17726618283001L, 17726618285555L, 17726618283021L, 17726618212071L, (byte)10,
				0L, new BigInteger("1000778800000001886620000012222"), (byte)5, TupleType.LONG_UNKNOWN);
	...
	public void testSerialize_HalfRelativeAndSmallVolume() {
		tuple = new KafkaTuple(17726618283001L, 17726618201021L, -94522L, -586L, (byte)14,
				1L, null, (byte)2, TupleType.LONG_UNKNOWN);
