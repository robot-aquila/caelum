...
public class Pk1UtilsTest {
    ...
    public void testCanStoreNumberOfDecimalsInHeader() {
        ...
        for ( int i = 0; i < fixture.length; i ++  ) {
            ...
            var header = Pk1TestUtils.tupleHeaderBuilderRandom()
                    .decimals(decimals)
            ...
            assertEquals(new StringBuilder()
                    ...
                    .toString(), expected, service.canStoreNumberOfDecimalsInHeader(header));
        }
    }
    ...
    public void testCanStoreOhlcSizesInHeader() {
        ...
        for ( int i = 0; i < fixture.length; i ++ ) {
            ...
            assertEquals(new StringBuilder()
                    ...
                    .toString(), expected, service.canStoreOhlcSizesInHeader(header));
        }
    }
